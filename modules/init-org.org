* Install some useful packages
  #+begin_src emacs-lisp
    (my-install-packages '(org-bullets org-toc company-math pcsv))
  #+end_src
...
** Exclude trees with TOC tag
   org already exports a better table of contents, org-toc I find org-toc useful
   for org-documents that are do not need to be exported
   #+begin_src emacs-lisp
     (eval-after-load "ox"
