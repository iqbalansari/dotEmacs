* Code to speed up the loading of modules
  ...
  #+begin_src emacs-lisp
    ...
    (defun iqbal-compile-modules (modules)
      (interactive (list (iqbal-get-newer-module-files)))
      (dolist (module-file modules)
    ...
    (defun iqbal-compile-and-load-modules ()
      (interactive)
      (let ((newer-module (iqbal-get-newer-module-files)))
        (when newer-module
          (iqbal-compile-modules newer-module))
