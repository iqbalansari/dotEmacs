...
* Disable syntax checking on idle-change and new-line
  #+begin_src emacs-lisp
    (eval-after-load "flycheck"
      '(setq flycheck-check-syntax-automatically (delq 'new-line (delq 'idle-change flycheck-check-syntax-automatically))))
  #+end_src
