...
** Use default keybindings
  #+begin_src emacs-lisp
    ...
    (with-eval-after-load 'org
      (org-defkey org-mode-map (kbd  "<S-left>")  'windmove-left)
      (org-defkey org-mode-map (kbd  "<S-right>") 'windmove-right)
      (org-defkey org-mode-map (kbd  "<S-up>")    'windmove-up)
      (org-defkey org-mode-map (kbd  "<S-down>")  'windmove-down))
  #+end_src
