...
* A more colorful elfeed search buffer
  ...
  #+BEGIN_SRC emacs-lisp
    (defface iqbal-elfeed-comics
      '((t :foreground "#BFF"))
      "Marks comics in Elfeed.")

    (defface iqbal-elfeed-audio
      '((t :foreground "#FA0"))
      "Marks podcasts in Elfeed.")

    (with-eval-after-load 'elfeed
      (push '(comics iqbal-elfeed-comics) elfeed-search-face-alist)
      (push '(podcast iqbal-elfeed-audio) elfeed-search-face-alist))
  #+END_SRC
