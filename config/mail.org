...
*** Custom mode-line indicator for mail
   #+begin_src emacs-lisp
     (defvar my-mail-mode-line)
     (add-to-list 'global-mode-string '(:eval my-mail-mode-line) t)
...
*** Function to update mail count
    #+begin_src emacs-lisp
      (defun my-update-mail-mode-line ()
        (setq my-mail-mode-line (my-get-mailcount-mode-line-string (my-mu-get-unread-mail-count)))
...
**** Update mode-line when mu4e loads
     #+begin_src emacs-lisp
       (eval-after-load 'mu4e
         '(my-update-mail-mode-line))
     #+end_src

**** Update mode-line after executing marks
    #+begin_src emacs-lisp
      (defun my-setup-mail-count-update-after-exec-marks ()
        (defadvice mu4e-mark-execute-all (after my-update-mail-count)
          (my-update-mail-mode-line))
        (ad-activate 'mu4e-mark-execute-all))

      (eval-after-load 'mu4e
        '(my-setup-mail-count-update-after-exec-marks))
    #+end_src

**** Update mode-line after viewing a message
     #+begin_src emacs-lisp
       (add-hook 'mu4e-view-mode-hook #'my-update-mail-mode-line)
     #+end_src

**** Update mode-line after fetching mail
     #+begin_src emacs-lisp
       (add-hook 'mu4e-index-updated-hook #'my-update-mail-mode-line)
     #+end_src
