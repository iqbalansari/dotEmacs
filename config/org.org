* Install some useful packages
  #+begin_src emacs-lisp
    (my-install-packages '(org-bullets toc-org company-math pcsv))

    (when (locate-library "pdf-tools")
      (my-install-package 'org-pdfview))

    (when (string-match-p "^gnome-" (or (getenv "DESKTOP_SESSION") ""))
      (my-install-package 'org-gnome))
  #+end_src
...
* Configuration for org-mode gnome integration
  #+begin_src emacs-lisp
    (when (locate-library "org-gnome")
      (setq org-gnome-integrate-with-empathy nil)
      (setq org-gnome-integrate-with-calendar t)
      (global-org-gnome-minor-mode)
      (setq appt-disp-window-function #'og-notify-appt))
  #+end_src
