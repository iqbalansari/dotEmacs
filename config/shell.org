...
* Use C-S-w to quickly kill comint/compilation mode buffers
  #+begin_src emacs-lisp
    ...
    (eval-after-load "compile"
      '(progn (define-key compilation-mode-map (kbd "C-S-w") #'iqbal-kill-buffer-delete-window)
              (define-key compilation-minor-mode-map (kbd "C-S-w") #'iqbal-kill-buffer-delete-window)))
  #+end_src
...
** Capture C-n, C-p, C-a, C-e, M-< and M-> is region is active or send
   ...
   #+begin_src emacs-lisp
     (eval-after-load 'term
       '(progn (define-key term-raw-map "\C-n" 'iqbal-execute-command-if-region-or-send-raw)
...
** Keybindings
   #+begin_src emacs-lisp
     ...
     (eval-after-load "term"
       '(progn (define-key term-raw-map (kbd "C-|") #'iqbal-split-window-right-start-terminal)
...
* Clear comint based REPL
  ...
  #+begin_src emacs-lisp
    ...
    (eval-after-load "comint" '(define-key comint-mode-map "\C-c\M-o" #'iqbal-comint-clear-buffer))
  #+end_src
