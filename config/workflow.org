* Install org-projectile, orgit and org-journal
  #+BEGIN_SRC emacs-lisp
    (require 'orgbox)
    (iqbal-install-packages '(org-projectile org-journal org-dashboard orgbox orgit calfw))
  #+END_SRC
...
* Command to call org-capture in a separate frame
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    http://www.glassberg-powell.com/blog/20140709/emacs-org-mode-capture-anywhere"
      ...
      (cl-flet (((symbol-function 'switch-to-buffer-other-window) #'switch-to-buffer))
