...
* Ace jump mode configuration
  ...
  #+begin_src emacs-lisp
    (defadvice ace-jump-list-visual-area (after iqbal-no-ace-mode-in-docview (&rest args))
...
* DWIM versions of upcase-word and friends
  ...
  #+begin_src emacs-lisp
    ...
    (iqbal-work-on-region-or-word iqbal-upcase-dwim "Downcase word or region" upcase-word upcase-region)
    (iqbal-work-on-region-or-word iqbal-downcase-dwim "Upcase word or region" downcase-word downcase-region)
