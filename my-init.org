...
** 6. Function to load language configuration
   ...
   #+begin_src emacs-lisp
     ...
     (defmacro my-load-lang (language)
       `(lambda ()
          (let (auto-mode-alist)
...
** C
   #+begin_src emacs-lisp
     (add-to-list 'auto-mode-alist (cons "\\.c\\'" (my-load-lang "c")))
   #+end_src

** Python
  #+begin_src emacs-lisp
    (add-to-list 'auto-mode-alist (cons "\\.py\\'" (my-load-lang "python")))
  #+end_src

** Javascript
   #+begin_src emacs-lisp
     (add-to-list 'auto-mode-alist (cons "\\.js\\'"  (my-load-lang "javascript")))
   #+end_src

** HTML mode
   #+begin_src emacs-lisp
     (add-to-list 'auto-mode-alist (cons "\\.html\\'" (my-load-lang "html")))
   #+end_src

** CSS mode
  #+begin_src emacs-lisp
    (add-to-list 'auto-mode-alist (cons "\\.css\\'" (my-load-lang "css")))
    
  #+end_src

** Scheme mode
   #+begin_src emacs-lisp
     (add-to-list 'auto-mode-alist (cons "\\.rkt\\'" (my-load-lang "scheme")))
   #+end_src

** Common-lisp mode
   #+begin_src emacs-lisp
     (add-to-list 'auto-mode-alist (cons "\\.li?sp\\'" (my-load-lang "common-lisp")))
   #+end_src

** SML mode
   #+begin_src emacs-lisp
     (add-to-list 'auto-mode-alist (cons "\\.\\(sml\\|sig\\)\\'" (my-load-lang "sml")))
   #+end_src

** OCaml mode
   #+begin_src emacs-lisp
     (add-to-list 'auto-mode-alist (cons "\\.ml[iylp]?" (my-load-lang "ocaml")))
   #+end_src

** Better mode for working with JSON
   #+begin_src emacs-lisp
     (add-to-list 'auto-mode-alist (cons "\\.json\\'" (my-load-lang "json")))
   #+end_src

** Markdown mode
   #+begin_src emacs-lisp
     (add-to-list 'auto-mode-alist (cons "\\.\\(markdown\\|md\\)\\'" (my-load-lang "markdown")))
   #+end_src

** Apache
   #+begin_src emacs-lisp
     (add-to-list 'auto-mode-alist (cons "\\.htaccess\\'" (my-load-lang "apache")))
     (add-to-list 'auto-mode-alist (cons "httpd\\.conf\\'" (my-load-lang "apache")))
     (add-to-list 'auto-mode-alist (cons "srm\\.conf\\'" (my-load-lang "apache")))
     (add-to-list 'auto-mode-alist (cons "access\\.conf\\'" (my-load-lang "apache")))
     (add-to-list 'auto-mode-alist (cons "sites-\\(available\\|enabled\\)/" (my-load-lang "apache")))
   #+end_src

** Scala
   #+begin_src emacs-lisp
     (add-to-list 'auto-mode-alist (cons "\\.\\(scala\\|sbt\\)\\'" (my-load-lang "scala")))
   #+end_src

** Erlang
   #+begin_src emacs-lisp
     (add-to-list 'auto-mode-alist (cons "\\.erl$" (my-load-lang "erlang")))
   #+end_src
